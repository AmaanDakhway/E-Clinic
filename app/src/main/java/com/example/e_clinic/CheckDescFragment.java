...
public class CheckDescFragment extends Fragment {
    ...
    public CheckDescFragment() {
        // Required empty public constructor
    }

    public CheckDescFragment(String age, String bloodGroup, String date, String doctor, String email, String gender, String name, String phone, String symptoms, String time) {
        this.age = age;
    ...
    public static CheckDescFragment newInstance(String param1, String param2) { CheckDescFragment fragment = new CheckDescFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_check_desc, container, false);
    ...
    public void onBackPressed(){
        ...
        activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper1,new checkrecfragment()).addToBackStack(null).commit();
